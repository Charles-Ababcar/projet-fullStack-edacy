...
export function DashboardHome() {
  const stats = [
    ...
    { title: "Revenue", value: "$34,567", change: "+8.2%", trend: "up" },
    { title: "Orders", value: "1,234", change: "-3.1%", trend: "down" },
    { title: "Conversion", value: "3.2%", change: "+0.4%", trend: "up" },
  ];
                ...
                >
                  {stat.trend === "up" ? (
                    <svg className="w-3 h-3" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M12 7a1 1 0 01-1.7-.7l-2-3a1 1 0 111.7-1.4l2 3a1 1 0 010 1.4z" clipRule="evenodd" />
                    </svg>
                  ) : (
                    <svg className="w-3 h-3" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M12 13a1 1 0 01-.7.3 1 1 0 01-.7-.3l-2-3a1 1 0 111.4-1.4l2 3a1 1 0 010 1.4z" clipRule="evenodd" />
                    </svg>
                  )}
                  {stat.change}
                </Badge>
